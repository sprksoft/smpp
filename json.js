			...
			<svg xmlns="http://www.w3.org/2000/svg" id="Laag_2" height="65px" width="65px" data-name="Laag 2" viewBox="0 0 24.28 25.14">
			  ...
			  <g id="Laag_1-2" data-name="Laag 1">
				<g>
				  ...
				  <path class="st1" d="M19,0c-1.97,0-3.57,1.6-3.57,3.57s1.6,3.57,3.57,3.57,3.57-1.61,3.57-3.57-1.6-3.57-3.57-3.57ZM19,5.14c-.87,0-1.57-.7-1.57-1.57s.7-1.57,1.57-1.57,1.57.71,1.57,1.57-.7,1.57-1.57,1.57Z"/>
...
<div class="col colSmall">
  <p class="weather-location weather-locationSmall"></p>
  <p class="weather-main weather-mainSmall"></p>
</div>
<div class="col colSmall">
<p class="weather-temperature weather-temperatureSmall"></p>
<div class="weather">
  <div src="https://raw.githubusercontent.com/frickingbird8002/smpp-images/main/chanceflurries.svg" class="weather-icon weather-iconSmall"></div>
</div>
</div>
<p class="weather-feelslike weather-feelslikeSmall"></p>
<div class="weather-humwind weather-humwindSmall">
<div class="col colSmall"><svg xmlns="http://www.w3.org/2000/svg" height="40px" width="40px" version="1.1" id="Layer_1" viewBox="0 0 512 512" xml:space="preserve">
<g id="XMLID_6_">
...
<p class="weather-humidity weather-humwindSmall"></p>
<p class="weather-humidity weather-humwindSmall">Humidity</p></div>
</div>
<div class="weather-humwind weather-humwindSmall">
<div class="col colSmall"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="40px" width="40px" version="1.1" id="Layer_1" viewBox="0 0 512 512" xml:space="preserve">
<g>
...
<p class="weather-wind weather-windSmall"></p>
<p class="weather-wind weather-windSmall">Wind Speed</p></div>
</div>
</div>
