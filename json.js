...
const settingsSvg = `
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" class=text-color-fill height="18px" width="18px" 
	 viewBox="0 0 48 48" style="enable-background:new 0 0 48 48;" xml:space="preserve"> <path d="M39.139,26.282C38.426,25.759,38,24.919,38,24.034s0.426-1.725,1.138-2.247l3.294-2.415
...
const gotoSvg = `<svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class=text-color-fill>
<path d="M3 19H5V5H3V19ZM10 5V11H17.59L6 17.59L7.41 19L19 7.41V15H21V5H10Z" fill="currentColor"/>
</svg>`;

const linksSvg = `<svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class=text-color-fill>
<path d="M17 7H14V5C14 3.9 13.1 3 12 3C10.9 3 10 3.9 10 5V7H7C6.45 7 6 7.45 6 8C6 8.55 6.45 9 7 9H10V11C10 12.1 10.9 13 12 13C13.1 13 14 12.1 14 11V9H17C17.55 9 18 8.55 18 8C18 7.45 17.55 7 17 7ZM19 13H16V11C16 9.9 15.1 9 14 9C12.9 9 12 9.9 12 11V13H9C8.45 13 8 13.45 8 14C8 14.55 8.45 15 9 15H12V17C12 18.1 12.9 19 14 19C15.1 19 16 18.1 16 17V15H19C19.55 15 20 14.55 20 14C20 13.45 19.55 13 19 13Z" fill="currentColor"/>
</svg>`;

const coursesSvg = `<svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class=text-color-fill>
<path d="M5 4H19C20.1 4 21 4.9 21 6V18C21 19.1 20.1 20 19 20H5C3.9 20 3 19.1 3 18V6C3 4.9 3.9 4 5 4ZM12 17C13.65 17 15 15.65 15 14C15 12.35 13.65 11 12 11C10.35 11 9 12.35 9 14C9 15.65 10.35 17 12 17ZM17 9H7V7H17V9Z" fill="currentColor"/>
</svg>`;
