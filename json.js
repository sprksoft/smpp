...
<div class="col colSmall">
	<svg xmlns="http://www.w3.org/2000/svg" id="layer1" data-name="Laag 2" height="35px" width="35px" viewBox="0 0 29.83 24.41">
	  <defs>
		<style>
		  .cls-1 {
			fill-rule: evenodd;
...
<div class="weather-humwind weather-humwindSmall">
<div class="col colSmall">
<svg xmlns="http://www.w3.org/2000/svg" id="Laag_2" height="40px" width="40px" data-name="Laag 2" viewBox="0 0 39.94 24.5">
		  <defs>
			<style>
			  .cls-1 {
				fill: #000;
  ...
  <p class="weather-humidity weather-humwindSmall">Humidity</p>

    <p class="weather-wind weather-windSmall"></p>
    <p class="weather-wind weather-windSmall"></p>
    <p class="weather-wind weather-windSmall">Wind Speed</p>
