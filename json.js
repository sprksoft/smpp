...
const popupsettingHTML = `
<label class=performanceModeTooltipLabel id=performanceModeTooltipLabel>
    <input type=checkbox id=performanceModeTooltip>
    ${performanceModeSvg}
    </label>
    <span id=performanceModeInfo></span>
    ...
    <select id="profileSelector">
        ...
        <option value="pink">Cherry Haze</option>
    </select>
    ...
    <div class="textandbutton">
        <input class="popupinput" id="location" spellcheck="false" type="text"></input>
        <label class="switch">
    ...
    <div class="textandbutton">
        <div class="verticaltext">
            <p class="nobottommargp off_text">Off</p>
            <p class="nobottommargp link_text">Link</p>
            <p class="nobottommargp">File</p>
        </div>
        <input type="range" min="0" max="2" value="0" class="sliderblur" id="backgroundSlider">
        <input class="popupinput" id="backgroundlink" spellcheck="false" type="text"></input>
        <input class="popupinput" class="backgroundfile" id="fileInput" style="display: none;" type="file"
            accept=".png, .jpg, .jpeg"></input>
        <button class="popupinput" class="backgroundfile" id="backgroundfilebutton"><svg width="30px" height="30px"
    ...
    <div class="textandbutton" style="margin-top: 20px !important">
        <div class="verticaltext">
            <p class="nobottommargp off_text">Snow</p>
            <p class="nobottommargp link_text">Realtime</p>
            <p class="nobottommargp">Rain</p>
        </div>
