...
async function createWeatherApp(location, isBig) {
  ...
  let timeDifferenceMins = Math.round(Math.abs((lastUpdateDate - new Date())) / 1000 / 60);
  let weatherData = weatherAppData.weatherData;
  if (timeDifferenceMins > 10 || location != weatherAppData.lastLocation
    || wasMigrated || !weatherData) {
